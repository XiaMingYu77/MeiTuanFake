<template>
    <div class="store">
        ...
        <div class="content">
            ...
            <div class="foodList">
                ...
                <van-tabs color="#FFDC01">
                  <van-tab title="点菜"> <FoodList :foodData="storeDataRes.storeData[0].data"/></van-tab>
                  <van-tab title="评价"> <Appraise :appraiseData="storeDataRes.storeData[1].data"/> </van-tab>
                  <van-tab title="商家"> <StoreProfile :storeProfileData="storeDataRes.storeData[2].data"/> </van-tab>
                </van-tabs>
            </div>
        </div> 
        ...
        <van-action-bar>
            ...
            <van-action-bar-icon icon="cart-o" text="购物车" :badge="store.state.cartMap.size" 
            @click="goToCart"/>
